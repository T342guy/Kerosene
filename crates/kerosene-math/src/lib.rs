...
//! Core math for Kerosene.
//!
//! Kerosene inherits Source's conventions, because the tools and the map
...
//!   is what brush geometry, `.keromap` files and the entity angle conventions
//!   all assume.
