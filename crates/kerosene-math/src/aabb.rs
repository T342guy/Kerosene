...
mod tests {
    ...
    fn longest_axis_picks_the_widest() {
        assert_eq!(
            Aabb::new(Vec3::ZERO, Vec3::new(1.0, 5.0, 2.0)).longest_axis(),
            1
        );
        assert_eq!(
            Aabb::new(Vec3::ZERO, Vec3::new(9.0, 5.0, 2.0)).longest_axis(),
            0
        );
        assert_eq!(
            Aabb::new(Vec3::ZERO, Vec3::new(1.0, 5.0, 9.0)).longest_axis(),
            2
        );
    }
}
