...
mod tests {
    ...
    fn mouse_movement_turns_the_view() {
        ...
        console.register_cvar("sensitivity", "3", kerosene_console::ConVarFlags::NONE, "");
        console.register_cvar("m_yaw", "0.022", kerosene_console::ConVarFlags::NONE, "");
        console.register_cvar("m_pitch", "0.022", kerosene_console::ConVarFlags::NONE, "");
        console.register_cvar("m_invert", "0", kerosene_console::ConVarFlags::NONE, "");
