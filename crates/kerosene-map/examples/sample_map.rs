...
//! rather than by hand keeps the brush geometry exact -- a `.keromap` stores
...
fn main() -> std::io::Result<()> {
    ...
    map.world.set("message", "Kerosene -- sample level");
    ...
    let path = std::path::Path::new("content/maps/kero_start.keromap");
